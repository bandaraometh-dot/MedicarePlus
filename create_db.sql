  -- SQL schema for MedicarePlus (updated)
  ...
  -- Messages (internal messaging / contact)
  ...
  -- Use PHP's password_hash to generate a secure password hash and insert into `users(password_hash)`
