...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($ok) {
            ...
            $stmt->bind_param('iss', $user_id, $dob, $gender);
            $stmt->execute();
            $stmt->close();
            redirect('admin-patients.php?success=1');
        } else {
...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo ($current === 'admin-patients-create.php') ? 'active' : ''; ?>"><a href="admin-patients.php"><i class="fas fa-user-injured"></i> Patients</a></li>
        </ul>
    ...
    <div class="main-content">
        <div class="container">
            <div class="content-header"><div class="header-left"><h1>Add Patient</h1><p>Create a new patient account</p></div></div>
            <?php if (!empty($errors)): ?><div class="alert error"><?php echo esc(implode(' ', $errors)); ?></div><?php endif; ?>

            <form method="post" action="admin-patients-create.php" style="max-width:700px;">
                <div class="form-row">
                ...
                <div style="margin-top:12px;"><button class="btn-primary" type="submit">Create Patient</button> <a class="card-link" href="admin-patients.php">Cancel</a></div>
            </form>
        </div>
    </div>
</body>
